...
- **Vault workspace density**: the aligned Vaults / Collections / location row is
  ...
  In the primary form column, each governance section uses a strong panel edge,
  a neutral `surface-2` header and one meaningfully toned icon anchor; generous
...
| `SettingsSectionHeader`                                | shared General / Access / Vault guide header for the Settings form column; uses neutral `surface-2` layering plus a meaningful `TonalIcon` tone so hierarchy does not borrow selected-state semantics.                                                                                                                                                                                                                                                                                                                                              |
