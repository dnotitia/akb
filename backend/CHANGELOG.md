...
swap. Known blocking filesystem/S3/hash/regex/response-encoding paths are kept
off the API loop, and migration/role reconciliation startup is serialized for
